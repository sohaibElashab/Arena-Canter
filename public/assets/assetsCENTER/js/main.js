...
!(function($) {
  ...
  $(window).scroll(function() {
    if ($(this).scrollTop() > 100) {
      $('#headerS').addClass('headerS-scrolled');
    } else {
      $('#headerS').removeClass('headerS-scrolled');
    }
  });
...
$(document).ready(function() {
  $(".fogo").hover(
    function() {
      $("#logoTitle1").animate({ left: "56px" }, 100);
      $("#logoTitle2").animate({ left: "0px" }, 100);
    },
    function() {
      $("#logoTitle1").animate({ left: "5px" }, 100);
      $("#logoTitle2").animate({ left: "34px" }, 100);
    }
  );
});
